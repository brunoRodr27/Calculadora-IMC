...
class ResultadoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewResultadoDensidadeCorporal1.text = String.format("%.2f", imc.imc)
        textViewPeso.text = String.format("%.2f", imc.peso)
        textViewAltura.text = String.format("%.2f", imc.altura)
